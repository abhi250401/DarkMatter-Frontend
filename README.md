...
### Note  :  This is only the front and won't be much of use without the backend you also need to run the backend on your local enviorment link for the repo of backend is here :
https://github.com/abhi250401/DarkMatter-Backend/
